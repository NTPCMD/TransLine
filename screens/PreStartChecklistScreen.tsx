  ...
  const [sections, setSections] = useState<ChecklistSection[]>([
    {
      ...
      expanded: true,
      items: [
        { id: 'tyre-pressure', label: 'Tyre pressure adequate', status: null, note: '' },
        { id: 'tyre-tread', label: 'Tread depth acceptable', status: null, note: '' },
        { id: 'wheel-nuts', label: 'Wheel nuts secure', status: null, note: '' },
      ]
    },
    {
      id: 'lights',
      ...
      expanded: false,
      items: [
        { id: 'headlights', label: 'Headlights working', status: null, note: '' },
        { id: 'indicators', label: 'Indicators working', status: null, note: '' },
        { id: 'brake-lights', label: 'Brake lights working', status: null, note: '' },
      ]
    },
    {
      id: 'fluids',
      ...
      expanded: false,
      items: [
        { id: 'engine-oil', label: 'Engine oil level', status: null, note: '' },
        { id: 'coolant', label: 'Coolant level', status: null, note: '' },
        { id: 'washer-fluid', label: 'Washer fluid', status: null, note: '' },
      ]
    },
    {
      id: 'brakes',
      ...
      expanded: false,
      items: [
        { id: 'brake-function', label: 'Brake function test', status: null, note: '' },
        { id: 'park-brake', label: 'Park brake working', status: null, note: '' },
      ]
    },
    {
      id: 'exterior',
      ...
      expanded: false,
      items: [
        { id: 'body-damage', label: 'No visible body damage', status: null, note: '' },
        { id: 'windscreen', label: 'Windscreen intact', status: null, note: '' },
        { id: 'mirrors', label: 'Mirrors intact and clean', status: null, note: '' },
      ]
    }
  ]);
