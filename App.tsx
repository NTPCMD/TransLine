    ...
    switch (currentScreen) {
      ...
      case 'pre-start-checklist':
        return <PreStartChecklistScreen
          onSubmit={() => navigate('readings-photos')}
          onBack={() => navigate('start-shift')}
        />;
      
      case 'readings-photos':
        return <ReadingsAndPhotosScreen
          onContinue={(readings, photos) => {
            updateAppState({ 
              odometerReading: readings.odometer,
              odometerPhoto: photos.odometer,
              manualReading: readings.manual,
              manualPhoto: photos.manual,
              shiftStarted: true,
      ...
      case 'shift-details':
        return <ShiftDetailsScreen
          ...
          manualReading={appState.manualReading}
          manualPhoto={appState.manualPhoto}
